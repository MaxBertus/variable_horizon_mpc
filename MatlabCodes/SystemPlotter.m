classdef SystemPlotter
    ...
    methods
        ...
        function updateLoadPos(obj, x_now_l, x_now_f, loadTheta)
            ...
            obj.leaderLoadPos.Shape.Vertices = ...
                (x_now_l(1:2) + obj.leaderParams.robotShape)';
            obj.followerLoadPos.Shape.Vertices = ...
                  (x_now_f(1:2) + obj.followerParams.robotShape)';
            % obj.followerLoadPos.Shape.Vertices(5:8,:) = ...
            %       (x_now_f(1:2) + obj.followerParams.robotShape(:,5:8))';
        end
